...
def mp_seleccionada(w,cuadro,entrada_ruta_bd,deposito_selec,mp_selec,combobox_lote,cantidad_pesar,n_debatch,cuadro_macro,deposito_macro_selec,mp_selec_macro,combobox_lote_macro,cantidad_pesar_macro,ndebatch_macro,s):
