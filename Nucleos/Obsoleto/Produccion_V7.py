...
boton_finalizar.place(relx=0.5, rely=0.198,relheight = 0.08)
boton_finalizar = ttk.Button(pestaña_prod, text="Programar", command = partial (nuevo,"nucleos"))
boton_finalizar.place(relx=0.5, rely=0.1,relheight = 0.08)
