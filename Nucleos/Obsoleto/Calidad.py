...
boton_cargar.place(relx=0.47, rely=0.13, relheight=0.07)
boton_liberar = ttk.Button(pestaña_prod, text="Liberar", command=liberar)
boton_liberar.place(relx=0.47, rely=0.2, relheight=0.07)
boton_verificar = ttk.Button(pestaña_prod, text="verificar", command=verificar)
boton_verificar.place(relx=0.47, rely=0.27, relheight=0.07)
...
boton_eliminar.place(relx=0.47, rely=0.41, relheight=0.07)
boton_retener= ttk.Button(pestaña_prod, text="Retener", command=retener)
boton_retener.place(relx=0.47, rely=0.34, relheight=0.07)
