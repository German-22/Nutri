...
pestaña_despacho = ttk.Frame(tab_control, borderwidth=10, relief="solid")
...
contenedor_tree = ttk.Frame(pestaña_despacho)
contenedor_tree.place(relx=0,rely=0.3, relheight=0.5,relwidth=0.96)
...
ttk.Label(pestaña_despacho, text="Chofer").place(relx=0.01, rely=0.02)
entrada_chof = ttk.Entry(pestaña_despacho, width= 30)
entrada_chof.place(relx=0.1, rely=0.02)
ttk.Label(pestaña_despacho, text="Patente").place(relx=0.01, rely=0.07)
entrada_pat = ttk.Entry(pestaña_despacho, width= 30)
entrada_pat.place(relx=0.1, rely=0.07)
ttk.Label(pestaña_despacho, text="Remito").place(relx=0.01, rely=0.12)
entrada_rem = ttk.Entry(pestaña_despacho, width= 30)
entrada_rem.place(relx=0.1, rely=0.12)
ttk.Label(pestaña_despacho, text="Estado").place(relx=0.35, rely=0.02)
entrada_est = ttk.Entry(pestaña_despacho, width= 30)
entrada_est.place(relx=0.42, rely=0.02)
ttk.Label(pestaña_despacho, text="Transporte").place(relx=0.35, rely=0.07)
entrada_tra = ttk.Entry(pestaña_despacho, width= 30)
entrada_tra.place(relx=0.42, rely=0.07)
